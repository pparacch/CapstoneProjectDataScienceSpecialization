...
model1_1.evaluation <- sapply(sentences, 
                              FUN = estimateSentenceProbabilities.trigrams.model.simplified.withGoodTuring.smoothing, 
                              t.terms = allSample.termFreq.3g$terms, t.counters = allSample.termFreq.3g$total)
...
model2.perplexity <- calculatePerplexity(stupidBackoff.model.base.evaluation)
```
...
StupidBackoff - no smoothing - allCorpora | `r model2.perplexity`

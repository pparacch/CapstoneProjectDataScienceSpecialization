...
```{r othersRemoval, echo = F, cache = F}
...
save(stopwords.profanityWords, data.twitter.all, data.news.all, data.blogs.all, file = "./datasetDumps/step1_afterCleaning.Rdata")
```
...
#load("./datasetDumps/step1_afterCleaning.Rdata")
...
save(stopwords.profanityWords, data.twitter.sample, data.news.sample, data.blogs.sample, file = "./datasetDumps/step2_afterSampling.Rdata")
...
#Use datasetDumps in order to not repeat previous steps
#load("./datasetDumps/step2_afterSampling.Rdata")
...
##Twitter Corpora
load("./datasetDumps/twitter.tdm.1g.Rdata")
load("./datasetDumps/twitter.tdm.2g.Rdata")
load("./datasetDumps/twitter.tdm.3g.Rdata")
...
save(corpora.allTermsFrequency, file = "./datasetDumps/twitter.allTermsFrequency.1g.Rdata")

corpora.allTermsFrequency <- NULL
corpora.tdm <- twitter.corpora.tdm.2g
corpora.allTermsFrequency <- getAllTermsFrequencyInCorpora.as.df(corpora.tdm = corpora.tdm, chunck = 2000)
save(corpora.allTermsFrequency, file = "./datasetDumps/twitter.allTermsFrequency.2g.Rdata")

corpora.allTermsFrequency <- NULL
corpora.tdm <- twitter.corpora.tdm.3g
corpora.allTermsFrequency <- getAllTermsFrequencyInCorpora.as.df(corpora.tdm = corpora.tdm, chunck = 2000)
save(corpora.allTermsFrequency, file = "./datasetDumps/twitter.allTermsFrequency.3g.Rdata")
...
load("./datasetDumps/news.tdm.1g.Rdata")
load("./datasetDumps/news.tdm.2g.Rdata")
load("./datasetDumps/news.tdm.3g.Rdata")

corpora.allTermsFrequency <- NULL
corpora.tdm <- news.corpora.tdm.1g
corpora.allTermsFrequency <- getAllTermsFrequencyInCorpora.as.df(corpora.tdm = corpora.tdm, chunck = 2000)
save(corpora.allTermsFrequency, file = "./datasetDumps/news.allTermsFrequency.1g.Rdata")

corpora.allTermsFrequency <- NULL
corpora.tdm <- news.corpora.tdm.2g
corpora.allTermsFrequency <- getAllTermsFrequencyInCorpora.as.df(corpora.tdm = corpora.tdm, chunck = 2000)
save(corpora.allTermsFrequency, file = "./datasetDumps/news.allTermsFrequency.2g.Rdata")

corpora.allTermsFrequency <- NULL
corpora.tdm <- news.corpora.tdm.3g
corpora.allTermsFrequency <- getAllTermsFrequencyInCorpora.as.df(corpora.tdm = corpora.tdm, chunck = 2000)
save(corpora.allTermsFrequency, file = "./datasetDumps/news.allTermsFrequency.3g.Rdata")
...
load("./datasetDumps/blogs.tdm.1g.Rdata")
load("./datasetDumps/blogs.tdm.2g.Rdata")
load("./datasetDumps/blogs.tdm.3g.Rdata")

corpora.allTermsFrequency <- NULL
corpora.tdm <- blogs.corpora.tdm.1g
corpora.allTermsFrequency <- getAllTermsFrequencyInCorpora.as.df(corpora.tdm = corpora.tdm, chunck = 2000)
save(corpora.allTermsFrequency, file = "./datasetDumps/blogs.allTermsFrequency.1g.Rdata")

corpora.allTermsFrequency <- NULL
corpora.tdm <- blogs.corpora.tdm.2g
corpora.allTermsFrequency <- getAllTermsFrequencyInCorpora.as.df(corpora.tdm = corpora.tdm, chunck = 2000)
save(corpora.allTermsFrequency, file = "./datasetDumps/blogs.allTermsFrequency.2g.Rdata")

corpora.allTermsFrequency <- NULL
corpora.tdm <- blogs.corpora.tdm.3g
corpora.allTermsFrequency <- getAllTermsFrequencyInCorpora.as.df(corpora.tdm = corpora.tdm, chunck = 2000)
save(corpora.allTermsFrequency, file = "./datasetDumps/blogs.allTermsFrequency.3g.Rdata")
...
load("./datasetDumps/twitter.allTermsFrequency.1g.Rdata")
twitter.allTerms.1g <- corpora.allTermsFrequency

load("./datasetDumps/twitter.allTermsFrequency.2g.Rdata")
twitter.allTerms.2g <- corpora.allTermsFrequency

load("./datasetDumps/twitter.allTermsFrequency.3g.Rdata")
...
load("./datasetDumps/news.allTermsFrequency.1g.Rdata")
news.allTerms.1g <- corpora.allTermsFrequency

load("./datasetDumps/news.allTermsFrequency.2g.Rdata")
news.allTerms.2g <- corpora.allTermsFrequency

load("./datasetDumps/news.allTermsFrequency.3g.Rdata")
...
load("./datasetDumps/blogs.allTermsFrequency.1g.Rdata")
blogs.allTerms.1g <- corpora.allTermsFrequency

load("./datasetDumps/blogs.allTermsFrequency.2g.Rdata")
blogs.allTerms.2g <- corpora.allTermsFrequency

load("./datasetDumps/blogs.allTermsFrequency.3g.Rdata")

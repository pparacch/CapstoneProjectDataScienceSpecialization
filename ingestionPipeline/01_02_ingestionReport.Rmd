---
title: "Ingestion Process Report"
...
For the creation of the language model __60%__ of the original corpora has been used. Six different random samples, 10% of the original corpora each, has been generated (seeds used for random sampling of the data `c(19711004, 19760126, 19411016, 19430604, 19710425, 20020126)`).
...
```{r loadData, warning = F, message = F, cache = F}
rm(list = ls())
...
```{r loadAllData, warning = F, message = F, cache = F}
rm(list = ls())
source("./scripts/visualization.R")

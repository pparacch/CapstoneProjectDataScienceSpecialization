        ...
        mainPanel(
            tabsetPanel(
                tabPanel("App Info",
                         ...
                         HTML("</ul>"),
                         h5("\"Next Words\" tab"),
                         p("Enter this tab to see the 5 next words that are made as prediction, based on the entered text, through a set of radio buttons. Next words are listed in decreasing probability order."),

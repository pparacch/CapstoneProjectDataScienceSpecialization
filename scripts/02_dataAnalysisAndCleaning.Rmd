...
ggplot(frequentTermsLimited.df[3:30,], aes(x = reorder(term,freq), y = freq/1000)) + 
        geom_bar(stat = "identity", fill="#E69F00") +xlab("Terms") + ylab("Frequency (* 1000)")+ ggtitle("Frequent 1-grams (top 30)")  + coord_flip()
wordcloud(words = frequentTermsLimited.df$term[-c(1,2)],
          freq = frequentTermsLimited.df$freq[-c(1,2)], 
          colors = mypalette, 
          scale=c(8,.3), 
          rot.per=.15)
```
...
ggplot(frequentTermsLimited.df[1:30,], aes(x = reorder(term,freq), y = freq/1000)) + 
        geom_bar(stat = "identity", fill="#56B4E9") +xlab("Terms") + ylab("Frequency (* 1000)")+ ggtitle("Frequent 2-grams (top 30)") + coord_flip()
wordcloud(words = frequentTermsLimited.df$term,freq = frequentTermsLimited.df$freq, colors = mypalette, scale=c(8,.3), rot.per=.15)
```
...
ggplot(frequentTermsLimited.df[1:30,], aes(x = reorder(term,freq), y = freq/1000)) + 
        geom_bar(stat = "identity", fill="#009E73") +xlab("Terms") + ylab("Frequency (* 1000)")+ ggtitle("Frequent 3-grams (top 30)") + coord_flip()
wordcloud(words = frequentTermsLimited.df$term,freq = frequentTermsLimited.df$freq, colors = mypalette, scale=c(8,.3), rot.per=.15)
```
...
ggplot(frequentTermsLimited.df[c(1,4:30),], aes(x = reorder(term,freq), y = freq/1000)) + 
        geom_bar(stat = "identity", fill="#E69F00") +xlab("Terms") + ylab("Frequency (* 1000)")+ ggtitle("Frequent 1-grams (top 30)") + coord_flip()
wordcloud(words = frequentTermsLimited.df$term[-c(2,3)],freq = frequentTermsLimited.df$freq[-c(2,3)], colors = mypalette, scale=c(8,.3), rot.per=.15)
```
...
ggplot(frequentTermsLimited.df[c(1,2,5:30),], aes(x = reorder(term,freq), y = freq/1000)) + 
        geom_bar(stat = "identity", fill="#E69F00") +xlab("Terms") + ylab("Frequency (* 1000)")+ ggtitle("Frequent 1-grams (top 30)") + coord_flip()
wordcloud(words = frequentTermsLimited.df$term[-c(3,4)],freq = frequentTermsLimited.df$freq[-c(3,4)], colors = mypalette, scale=c(8,.3), rot.per=.15)
```

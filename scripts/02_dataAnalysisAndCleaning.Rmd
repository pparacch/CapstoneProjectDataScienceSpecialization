...
```{r generateAllTermsFrequency, eval=T, echo = F}
...
idx <- order(twitter.allTerms.1g$freq, decreasing = T)
terms.term <- rownames(twitter.allTerms.1g)[idx][-c(1,2)]
terms.freq <- twitter.allTerms.1g$freq[idx][-c(1,2)]
...
plot(terms.cumulativeCoverage, type = "l", xlab = "Number Of Words", main = "Cumulative % (1-grams)")

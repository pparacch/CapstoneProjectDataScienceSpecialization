...
```{r loadProfanityWords, echo = F, cache = T}
...
* remove numbers
* remove punctuations - exceåt of the `'` in order to not lose contractions (e.g. I'll, I'm, etc)

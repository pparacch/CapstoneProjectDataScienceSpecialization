...
#Limit for testing purpose
data.twitter.all <- data.twitter.all[1:500000]
...
contractions <- Reduce(c,lapply(data.twitter.all[1:100000], findContractions))
...
tdm.1g <- tdm.generate(data.twitter.all.simple[1:30000], 1)
...
tdm.2g <- tdm.generate(data.twitter.all.simple[1:30000], 2)
...
tdm.3g <- tdm.generate(data.twitter.all.simple[1:100000], 3)
